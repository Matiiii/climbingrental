...
public class Application {
    ...
    public void initDatabase() {
        ...
        productRepository.save(new ProductEntity("PETZL GRIGRI II", 5.00, "rzyrząd asekuracyjny ze wspomaganym hamowaniem GRIGRI 2 został opracowany by ułatwiać asekurację.\n" +
                ...
                "\n" +
                "na okładce wygrawerowany schemat użycia", "https://www.polarsport.pl/media/catalog/product/d/1/d14bg-grigri-focus-2_lowres.jpeg", "https://www.polarsport.pl/media/catalog/product/d/1/d14bg-grigri-gris_lowres.jpeg", "gri gri,asekuracja,wspinaczka", 2, 2D));
